...
public class TwinAlgorithms {
    ...
    public static ArrayList<DeltaEdge> computeDeltaTwinsByEdgesIterationWithList(LinkStream ls, int delta) {
        Date startTime = new Date();

        ls.computeMatrixSuite();
        TimePartitionList[][] twinCandidates = new TimePartitionList[ls.getVertices().size()][ls.getVertices().size()];
                ...
                if ((!z.equals(e.getU())) && (!z.equals(e.getV()))) {
                        if (ls.getMatrixSuite().get(e.getT() - ls.getStartInstant())[ls.getVertices().indexOf(z)][ls
                            ...
                            if (twinCandidates[ls.getVertices().indexOf(e.getU())][ls.getVertices().indexOf(z)] == null) {
                                twinCandidates[ls.getVertices().indexOf(e.getU())][ls.getVertices().indexOf(z)] = new TimePartitionList(e.getT(), ls.getStartInstant(), ls.getEndInstant());
                                twinCandidates[ls.getVertices().indexOf(z)][ls.getVertices().indexOf(e.getU())] = new TimePartitionList(e.getT(),  ls.getStartInstant(), ls.getEndInstant());
                            }
                            else {
                                twinCandidates[ls.getVertices().indexOf(e.getU())][ls.getVertices().indexOf(z)].removeInstant(e.getT());
                                twinCandidates[ls.getVertices().indexOf(z)][ls.getVertices().indexOf(e.getU())].removeInstant(e.getT());
                            }
                        }
                    ...
                    if (ls.getMatrixSuite().get(e.getT() - ls.getStartInstant())[ls.getVertices().indexOf(z)][ls
                        ...
                        if (twinCandidates[ls.getVertices().indexOf(e.getV())][ls.getVertices().indexOf(z)] == null) {
                            twinCandidates[ls.getVertices().indexOf(e.getV())][ls.getVertices().indexOf(z)] = new TimePartitionList(e.getT(), ls.getStartInstant(), ls.getEndInstant());
                            twinCandidates[ls.getVertices().indexOf(z)][ls.getVertices().indexOf(e.getV())] = new TimePartitionList(e.getT(), ls.getStartInstant(), ls.getEndInstant());
                        }
                        else {
                            twinCandidates[ls.getVertices().indexOf(e.getV())][ls.getVertices().indexOf(z)].removeInstant(e.getT());
                            twinCandidates[ls.getVertices().indexOf(z)][ls.getVertices().indexOf(e.getV())].removeInstant(e.getT());
                        }
                    }
                }
            }
                ...
                if (twinCandidates[i][j] == null) {
                    ...
                    if (!twinCandidates[i][j].getAllDeltaIntervals(delta).isEmpty()) {
                        for (DeltaEdge e : twinCandidates[i][j].getAllDeltaIntervals(delta)) {
                            ...
                            //System.out.println("found twin: ("+e.getU().i+","+e.getV().i+") interval: ["+e.getStartInstant()+","+e.getEndInstant()+"]" );
                            twins.add(e);
                        }
                    }
                }
    ...
    public static ArrayList<DeltaEdge> computeDeltaTwinsByEdgesIterationWithoutMatricesWithList(LinkStream ls, int delta) {
        Date startTime = new Date();
